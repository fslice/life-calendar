...
export default function handler(req, res) {
  ...
  ${rects}
  <text x="${W / 2}" y="${bottomY}" text-anchor="middle" font-family="Courier New, monospace" font-size="80" font-weight="500" fill="#1a1a1a">${remaining}</text>
  <text x="${W / 2}" y="${bottomY + 55}" text-anchor="middle" font-family="Helvetica Neue, sans-serif" font-size="36" fill="#999999">days to go</text>
  <text x="${W / 2}" y="${bottomY + 110}" text-anchor="middle" font-family="Courier New, monospace" font-size="32" fill="#bbbbbb">${pct}%</text>
  <text x="${W / 2}" y="${bottomY + 155}" text-anchor="middle" font-family="Helvetica Neue, sans-serif" font-size="26" fill="#cccccc">${dateStr}</text>
</svg>`;
